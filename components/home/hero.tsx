...
export default function Hero() {
  return (
    <section className="bg-[url('/images/home/hero-background-2.png')] bg-[center_top_-70px] bg-repeat sm:bg-[center_top_0px] lg:h-fit lg:bg-[url('/images/home/hero-background.png')] lg:bg-cover xl:bg-[center_top_-100px]">
