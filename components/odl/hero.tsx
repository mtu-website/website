      ...
      <div className="flex items-center justify-between">
        <article className="my-auto h-auto w-[880px] px-6 lg:px-12 xl:px-24">
          ...
          <p className="my-12 font-sans text-sm font-medium leading-7 tracking-[-4%] text-[#FFFFFF99] lg:text-[16px]">
            ...
            traditional classrooms through its Open and Distance Learning (ODL)
            Center. Designed to meet the needs of learners, we offer innovative,
            flexible, and accessible education, ensuring students achieve their
