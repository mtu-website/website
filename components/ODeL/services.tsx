...
const cards = [
  {
    ...
    description:
      'Our ODeL programs are tailored for working professionals and busy individuals, providing a self-paced learning structure to balance education with other commitments. ',
  },
  {
    id: '2',
    ...
    description:
      'The ODeL Center offers cost-effective tuition with flexible payment options, making quality education accessible to a broader audience without financial strain.',
  },
  {
    id: '3',
  ...
  },
  {
    ...
    description:
      'We support our ODeL students with personalized online tutoring, mentorship, and career counseling, ensuring academic success and career readiness​',
  },
];
    ...
    <section className="bg-[#FFF1FF] px-6 py-12 lg:px-12 lg:py-24">
      <article className="mx-auto mb-12 w-fit">
        ...
        <h1 className="my-4 text-center font-sans text-xl font-medium leading-7 tracking-[-4%] text-[#0F0F0F] lg:text-2xl lg:leading-8 xl:text-4xl xl:leading-[45px]">
          What makes MTU Open Distance and e-Learning Center unique?
        </h1>
      </article>
